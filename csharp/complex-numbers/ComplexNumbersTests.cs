...
public class ComplexNumbersTests
{
    ...
    public void Imaginary_unit()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Mul(new ComplexNumber(0, 1)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Add_purely_real_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Add(new ComplexNumber(2, 0)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Add_purely_imaginary_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Add(new ComplexNumber(0, 2)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Add_numbers_with_real_and_imaginary_part()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Add(new ComplexNumber(3, 4)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Subtract_purely_real_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Sub(new ComplexNumber(2, 0)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Subtract_purely_imaginary_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Sub(new ComplexNumber(0, 2)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Subtract_numbers_with_real_and_imaginary_part()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Sub(new ComplexNumber(3, 4)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Multiply_purely_real_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Mul(new ComplexNumber(2, 0)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Multiply_purely_imaginary_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Mul(new ComplexNumber(0, 2)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Multiply_numbers_with_real_and_imaginary_part()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Mul(new ComplexNumber(3, 4)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Divide_purely_real_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Div(new ComplexNumber(2, 0)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Divide_purely_imaginary_numbers()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Div(new ComplexNumber(0, 2)).Imaginary(),
            precision: 7
        );
    }
    ...
    public void Divide_numbers_with_real_and_imaginary_part()
    {
        ...
        Assert.Equal(
            expected.Imaginary(),
            sut.Div(new ComplexNumber(3, 4)).Imaginary(),
            precision: 7
        );
    }
